...
def get_argparse():
    ...
    parser.add_argument('--out_video_idx', type = int, default = 0, help="index of output video.")
...
if __name__ == '__main__':
    ...
    if opt.test:
        ...
        scheduler = lambda optimizer: optim.lr_scheduler.ExponentialLR(optimizer, 0.99,last_epoch=-1)
