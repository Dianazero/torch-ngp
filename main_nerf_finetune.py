...
from nerf.utils_finetune import *
...
if __name__ == '__main__':
    ...
    ### training options
    parser.add_argument('--iters', type=int, default=10000000, help="training iters")
    ...
    parser.add_argument('--finetune', action='store_true', help="use finetune MLP")
    ...
    if opt.ff:
        ...
        from nerf.network_finetune import NeRFNetwork
    else:
    ...
    if opt.test:
        ...
        # scheduler = lambda optimizer: optim.lr_scheduler.ExponentialLR(optimizer, 0.999,last_epoch=-1)
