...
class Trainer(object):
    ...
    def test(self, loader, save_path=None):
        ...
        # save mp4
        writer = imageio.get_writer(os.path.join(save_path, f'{self.opt.out_video_idx:03d}.mp4'), fps=10)
        for im in render_imgs:
            writer.append_data(im)
        writer.close()

        writer = imageio.get_writer(os.path.join(save_path, f'{self.opt.out_video_idx:03d}_depth.mp4'), fps=10)
